...
class OnPolicyTrainer(RLTrainer):
  ...
  def _update_policy(self):
    ...
    self._stats_reporter.add_stat("Obs/block", block_count)
    self._stats_reporter.add_stat("Obs/wall", wall_count)
    self._stats_reporter.add_stat("Obs/goal", goal_count)
    self._stats_reporter.add_stat("Obs/switchoff", switchoff_count)
    self._stats_reporter.add_stat("Obs/switchon", switchon_count)
    self._stats_reporter.add_stat("Obs/stone_count", stone_count)
    self._stats_reporter.add_stat("Obs/nothing", nothing_count)
